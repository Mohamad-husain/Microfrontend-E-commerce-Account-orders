...
class BeautyAccount extends HTMLElement {
  ...
  static get observedAttributes() { return ['route', 'routing', 'hide-chrome']; }
  ...
  mount() {
    ...
    this.app = createApp(App); this.app.provide('beauty-hide-chrome', this.hasAttribute('hide-chrome') || this.hasAttribute('hidechrome') || (this as any).hideChrome === true); this.app.use(createPinia()).use(vuetify).use(this.router); this.app.mount(this);
